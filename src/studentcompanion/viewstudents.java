...
//            System.out.println("Statement Created");
        ...
        tabledata.setModel(model);
            tabledata.getColumnModel().getColumn(8).setCellRenderer(new ImageRenderer());
        tabledata.setRowHeight(100);
    }
     ...
     class ImageRenderer extends DefaultTableCellRenderer {
        ...
        public Component getTableCellRendererComponent(JTable table, Object value, boolean isSelected,
            ...
            try {
                ...
                BufferedImage image = ImageIO.read(new File(al.get(row).photo));

                lbl.setIcon(new ImageIcon(viewstudents.resize(image, 100, 100)));
